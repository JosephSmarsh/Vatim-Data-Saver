...
# set GEOS_dir manually here if automatic detection fails.
    GEOS_dir = 'E:/CS Projects/Vatim Data Saver/virtualenv/Lib/site-packages/geos'

user_home = os.path.expanduser('~')
geos_search_locations = [user_home, os.path.join(user_home, 'local'),
                         '/usr', '/usr/local', '/sw', '/opt', 'E:/CS Projects/Vatim Data Saver/virtualenv/Lib/site-packages/geos']
